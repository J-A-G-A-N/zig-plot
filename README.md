...
A simple plotting library in Zig that renders 2D plots and saves them as `.png` image files.
This library is underdevelopment.
This library currently allows you to:

- Draw Line points on a Cartesian coordinate system.
- Save the plotted image in  Png format.
